...
class GPUConfig
{
    ...
    private:
           ...
           so3StepBlocks(64)
        {
            ...
            icpStepMap["GeForce GTX 1650"] = std::pair<int, int>(256, 32);
            rgbStepMap["GeForce GTX 1650"] = std::pair<int, int>(224, 32);
            rgbResMap["GeForce GTX 1650"] = std::pair<int, int>(256, 496);
            so3StepMap["GeForce GTX 1650"] = std::pair<int, int>(352, 16);
