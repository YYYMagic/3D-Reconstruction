...
(cl:defmethod cl:initialize-instance :after ((m <start_svo_recording-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'start_svo_recording-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name zed_wrapper-srv:<start_svo_recording-request> is deprecated: use zed_wrapper-srv:start_svo_recording-request instead.")))

(cl:ensure-generic-function 'svo_filename-val :lambda-list '(m))
(cl:defmethod svo_filename-val ((m <start_svo_recording-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader zed_wrapper-srv:svo_filename-val is deprecated.  Use zed_wrapper-srv:svo_filename instead.")
  (svo_filename m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<start_svo_recording-request>)))
  ...
  "zed_wrapper/start_svo_recordingRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'start_svo_recording-request)))
  "Returns string type for a service object of type 'start_svo_recording-request"
  "zed_wrapper/start_svo_recordingRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <start_svo_recording-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'start_svo_recording-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name zed_wrapper-srv:<start_svo_recording-response> is deprecated: use zed_wrapper-srv:start_svo_recording-response instead.")))

(cl:ensure-generic-function 'result-val :lambda-list '(m))
(cl:defmethod result-val ((m <start_svo_recording-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader zed_wrapper-srv:result-val is deprecated.  Use zed_wrapper-srv:result instead.")
  (result m))

(cl:ensure-generic-function 'info-val :lambda-list '(m))
(cl:defmethod info-val ((m <start_svo_recording-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader zed_wrapper-srv:info-val is deprecated.  Use zed_wrapper-srv:info instead.")
  (info m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<start_svo_recording-response>)))
  ...
  "zed_wrapper/start_svo_recordingResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'start_svo_recording-response)))
  "Returns string type for a service object of type 'start_svo_recording-response"
  "zed_wrapper/start_svo_recordingResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'start_svo_recording)))
  ...
  "zed_wrapper/start_svo_recording")