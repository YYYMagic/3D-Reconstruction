...
(cl:defmethod cl:initialize-instance :after ((m <toggle_led-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'toggle_led-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name zed_wrapper-srv:<toggle_led-request> is deprecated: use zed_wrapper-srv:toggle_led-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <toggle_led-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'toggle_led-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name zed_wrapper-srv:<toggle_led-response> is deprecated: use zed_wrapper-srv:toggle_led-response instead.")))

(cl:ensure-generic-function 'new_led_status-val :lambda-list '(m))
(cl:defmethod new_led_status-val ((m <toggle_led-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader zed_wrapper-srv:new_led_status-val is deprecated.  Use zed_wrapper-srv:new_led_status instead.")
  (new_led_status m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<toggle_led-response>)))
  ...
  "zed_wrapper/toggle_ledResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'toggle_led-response)))
  "Returns string type for a service object of type 'toggle_led-response"
  "zed_wrapper/toggle_ledResponse")
