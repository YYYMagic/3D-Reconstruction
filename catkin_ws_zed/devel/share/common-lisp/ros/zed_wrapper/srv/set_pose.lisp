...
(cl:defmethod cl:initialize-instance :after ((m <set_pose-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'set_pose-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name zed_wrapper-srv:<set_pose-request> is deprecated: use zed_wrapper-srv:set_pose-request instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <set_pose-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader zed_wrapper-srv:x-val is deprecated.  Use zed_wrapper-srv:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <set_pose-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader zed_wrapper-srv:y-val is deprecated.  Use zed_wrapper-srv:y instead.")
  (y m))

(cl:ensure-generic-function 'z-val :lambda-list '(m))
(cl:defmethod z-val ((m <set_pose-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader zed_wrapper-srv:z-val is deprecated.  Use zed_wrapper-srv:z instead.")
  (z m))

(cl:ensure-generic-function 'R-val :lambda-list '(m))
(cl:defmethod R-val ((m <set_pose-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader zed_wrapper-srv:R-val is deprecated.  Use zed_wrapper-srv:R instead.")
  (R m))

(cl:ensure-generic-function 'P-val :lambda-list '(m))
(cl:defmethod P-val ((m <set_pose-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader zed_wrapper-srv:P-val is deprecated.  Use zed_wrapper-srv:P instead.")
  (P m))
...
(cl:defmethod cl:initialize-instance :after ((m <set_pose-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'set_pose-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name zed_wrapper-srv:<set_pose-response> is deprecated: use zed_wrapper-srv:set_pose-response instead.")))
