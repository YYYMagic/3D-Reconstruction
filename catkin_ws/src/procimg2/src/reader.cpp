...
void imageCalllback(const sensor_msgs::ImageConstPtr& msg_left, const sensor_msgs::Image::ConstPtr& msg)
{
	...
	try{
        ...
        */
        ...
        std::fstream outFile("~/proj/img/flg.txt",  std::ios::out );
        outFile << "1";
        cv::imwrite("~/proj/img/left.png", img_left);
        cv::imwrite("~/proj/img/left_elas.png",dst);
        outFile << "1";
        outFile.close();
        ...
        cv::imwrite("/home/yyy/proj/img_pro/rgb/" + str + ".png", img_left);
        cv::imwrite("/home/yyy/proj/img_pro/depth/" + str + ".png", dst);
        */
